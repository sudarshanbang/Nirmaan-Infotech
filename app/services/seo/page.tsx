...
export const metadata: Metadata = createMetadata({
  title: 'Technical SEO & Search Optimization | Nirmaan Infotech',
  description:
    'Strategic search engine optimization for businesses. Clean technical architecture, schema markup, Core Web Vitals tuning, and sustainable organic search rankings.',
  path: '/services/seo',
  keywords: [
    'Technical SEO Services',
    'Schema Markup Implementation',
    'Core Web Vitals Optimization',
    'Search Engine Optimization Pune India',
    'Nirmaan Infotech SEO',
  ],
});
