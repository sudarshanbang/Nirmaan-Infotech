    ...
    <div className="pt-28 pb-20 lg:pt-36 lg:pb-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <ScrollReveal className="max-w-3xl">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider bg-amber-500/10 border border-amber-500/20 text-amber-300 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <GlassCard variant="default" className="p-8">
            <h2 className="text-xl font-bold text-white mb-4">Modernization Focus</h2>
          ...
          <GlassCard variant="default" className="p-8">
            <h2 className="text-xl font-bold text-white mb-4">Redesign Deliverables</h2>
