...
export const metadata: Metadata = createMetadata({
  title: 'Website Redesign & Modernization | Nirmaan Infotech',
  description:
    'Upgrade your legacy website with modern aesthetics, fast load speeds, mobile responsiveness, and preserved SEO rankings to drive higher customer engagement.',
  path: '/services/website-redesign',
  keywords: [
    'Website Redesign Services',
    'Website Modernization Company',
    'UI UX Redesign India',
    'Legacy Website Upgrade',
    'Nirmaan Infotech Website Redesign',
  ],
});
