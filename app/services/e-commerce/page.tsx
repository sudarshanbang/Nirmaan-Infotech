    ...
    <div className="pt-28 pb-20 lg:pt-36 lg:pb-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <ScrollReveal className="max-w-3xl">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider bg-cyanAccent-400/10 border border-cyanAccent-400/20 text-cyanAccent-400 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <GlassCard variant="default" className="p-8">
            <h2 className="text-xl font-bold text-white mb-4">Store Features & Integrations</h2>
          ...
          <GlassCard variant="default" className="p-8">
            <h2 className="text-xl font-bold text-white mb-4">Deliverables & Technology</h2>
            <ul className="space-y-3 text-sm text-gray-300 mb-6">
              {service.deliverables.map((del, i) => (
                <li key={i} className="flex items-start gap-2.5">
                  <span className="w-2 h-2 rounded-full bg-cyanAccent-400 shrink-0 mt-2" />
                  <span>{del}</span>
                </li>
              ))}
            </ul>
