...
export const metadata: Metadata = createMetadata({
  title: 'E-Commerce Website Development | Nirmaan Infotech',
  description:
    'Custom e-commerce storefronts built for online sales. Seamless payment gateway integrations, mobile-first checkout, dynamic catalogs, and high security.',
