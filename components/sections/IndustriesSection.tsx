        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {industriesData.map((ind, index) => (
            <ScrollReveal key={ind.id} delay={index * 0.05}>
              <div className="glow group relative h-full rounded-2xl bg-white border border-[#e2e8f0] hover:border-[#1677FF] transition-all p-6 flex flex-col justify-between cursor-pointer shadow-sm hover:shadow-xl hover:shadow-[#1677FF]/10 overflow-hidden">
