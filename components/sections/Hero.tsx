...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[92vh] lg:min-h-screen pt-32 pb-20 lg:pt-40 lg:pb-28 flex items-center justify-center overflow-hidden z-10 bg-gradient-to-b from-[#f1f5f9] via-[#f8fafc] to-white border-b border-[#e2e8f0]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start space-y-6 md:space-y-8 text-left">
            ...
            >
              ...
              <span className="hidden sm:flex text-[#64748b] font-medium items-center gap-1">
                <Zap className="w-3.5 h-3.5 text-[#1677FF]" /> High-Performance Engineering
              </span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-[2rem] sm:text-6xl md:text-7xl lg:text-[5.2rem] font-bold tracking-[-0.035em] leading-[1.04] sm:leading-[0.98] text-[#071A36] font-heading break-words"
            >
              ENGINEERED <br />
            ...
            <motion.div
              ...
              className="pt-6 border-t border-[#e2e8f0] w-full grid grid-cols-3 gap-2 sm:gap-4"
            >
              <div>
                <p className="text-xl sm:text-3xl font-bold text-[#071A36] font-mono tracking-tight">150+</p>
                <p className="text-[10px] sm:text-xs text-[#64748b] font-normal mt-0.5 leading-tight">Projects Delivered</p>
              </div>
              <div>
                <p className="text-xl sm:text-3xl font-bold text-[#071A36] font-mono tracking-tight">99.8%</p>
                <p className="text-[10px] sm:text-xs text-[#64748b] font-normal mt-0.5 leading-tight">Client Satisfaction</p>
              </div>
              <div>
                ...
                <p className="text-[10px] sm:text-xs text-[#64748b] font-normal mt-0.5 leading-tight">Verified Rating</p>
              </div>
            </motion.div>
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center min-h-[380px] sm:min-h-[500px]">
            ...
            <motion.div
              ...
              className="relative w-full rounded-2xl bg-white border border-[#e2e8f0] shadow-xl p-4 sm:p-7 flex flex-col justify-between overflow-hidden group hover:shadow-2xl transition-all duration-500"
            >
              {/* TOP TERMINAL HEADER */}
              <div className="flex items-center justify-between pb-3.5 border-b border-[#e2e8f0] gap-2">
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 rounded-full bg-[#f1f5f9] text-[11px] sm:text-xs font-mono text-[#071A36] border border-[#e2e8f0] min-w-0 max-w-[170px] sm:max-w-none">
              ...
              <div className="my-5 font-mono text-xs leading-relaxed space-y-3 p-4 rounded-xl bg-[#071A36] text-white shadow-inner overflow-x-auto">
                <div className="text-slate-400 flex items-center justify-between">
                  <span>{"// Nirmaan Infotech Engine"}</span>
                  <span className="text-[#10B981] text-[10px] font-bold uppercase tracking-wider">● Live Output</span>
                </div>
                ...
                <div className="pt-2 border-t border-white/10 flex items-center justify-between text-[11px]">
                  <span className="text-slate-400">&gt; status: <span className="text-[#10B981] font-bold">READY_TO_DEPLOY</span></span>
                  <span className="text-[#1677FF] font-bold">0.4s</span>
                </div>
              </div>

              {/* FEATURED ELECTRIC BLUE CARD STRIP */}
              <div className="p-4 rounded-none bg-[#1677FF] text-white space-y-2 border-none">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-mono font-bold uppercase tracking-wider text-white/80">FEATURED OFFERING</span>
                  <span className="text-xs font-bold text-white bg-black/20 px-2 py-0.5 rounded-full">Editorial Choice</span>
                </div>
